...
public class Project07 extends Application
{
    ...
    // Bubble sort helpers
    int loopIndex = 2000; // Provides a running decrementer to reset the for loop a non-infinite amount of times
            ...
            public void handle(ActionEvent event)
            {
                ...
                switch(sortIdentifier)
                {
                    ...
                    case 2:
                    {
                        ...
                        while (loopIndex >= 0)
                        {
                            KeyFrame kf1 = new KeyFrame(Duration.seconds(.01+(frameCounter*.01)), actionEvent -> {
                            //KeyFrame kf1 = new KeyFrame(Duration.seconds(1+frameCounter), actionEvent -> {
                            ...
                            //KeyFrame kf3 = new KeyFrame(Duration.seconds(1+frameCounter), actionEvent -> {
                            ...
                            //KeyFrame kf4 = new KeyFrame(Duration.seconds(1+frameCounter), actionEvent -> {
